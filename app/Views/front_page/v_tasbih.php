                                ...
                                <div class="col d-flex justify-content-evenly align-items-center">
                                    ...
                                    <div class="buttonAddWrap">
                                        <a href="" class="buttonAdd" onclick="plusValueCounter(event)">
                                            <div class="card cardShadow" style="width:150px;height:150px;border-radius:50%;">
                                                <div class="card-body d-flex justify-content-center align-items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-hand-index-thumb-fill" viewBox="0 0 16 16">
